```{r, include=FALSE}
url <- "https://scienceverse.github.io/talks/2025-module-demo/"
...
title: "Module Demo"
subtitle: "`r subtitle`"
author: "![](images/papercheck.png){height=300}  ![](images/qrcode.svg){height=300}"
format: 
  revealjs:
...
In this section, I will introduce Papercheck, a new tool that leverages text search, code, and large language models to extract and supplement information from scientific documents (including manuscripts, submitted or published articles, or preregistration documents) and provides automated suggestions for improvement. 
