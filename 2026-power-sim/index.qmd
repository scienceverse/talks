...
We conducted a <i class="pt">sensitivity power analysis</i> using <i class="sw">custom simulation code and the R packages faux (DeBruine, 2026) and lme4 (Bates, Maechler, Bolker & Walker ,2015)</i> to determine the power for our <i class="st">expected parameters (@tbl-model-params)</i> using a <i class="a">critical alpha of 0.05</i>. With <i class="ss">100 subjects and 20 items</i>, and an effect of condition of <i class="es">10</i> <i class="esm">milliseconds</i>, simulation using <i class="sw">10 replications</i> determined a power of <i class="power">`r power_table$power[[2]]*100`%</i>.
